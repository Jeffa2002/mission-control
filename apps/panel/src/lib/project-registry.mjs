...
export const PROJECTS = [
  ...
  ['crossbench', 'Crossbench', 'Jeffa2002/crossbench', 'main', 'TypeScript', 'public', [], 'critical'],
  ...
  ['nurturerecord', 'NurtureRecord', 'Jeffa2002/nurturerecord', 'main', 'TypeScript', 'private', [], 'critical'],
  ...
  ['timepulse', 'TimePulse', 'Jeffa2002/timepulse', 'main', 'TypeScript', 'private', [], 'critical'],
...
].map(([id, name, repo, defaultBranch, language, visibility, localAliases, risk]) => ({
  id, name, repo, defaultBranch, language, visibility, localAliases, risk,
}));
