...
const MEMBERS: TeamMember[] = [
  ...
  },
  {
    ...
    emoji: '🦞',
    role: 'Lead Assistant',
    responsibilities: ['Plan & coordinate work', 'Safety checks', 'Ship end-to-end slices'],
  },
  {
    key: 'dev',
    type: 'agent',
  ...
  },
  {
    ...
    emoji: '🔬',
    role: 'Research',
    responsibilities: ['Web research, competitor analysis, API docs, synthesis'],
  ...
  },
  {
    ...
    emoji: '🕵️',
    role: 'Security',
    responsibilities: ['Security audits', 'CVE monitoring', 'Hardening', 'Vulnerability review'],
  },
];
